   ...
   <div class="row">  <!-- start main content row -->
      ...
      <div class="col-md-9">  <!-- start main content column -->
         <ol class="breadcrumb">
           ...
           <li class="active"><?php echo $images[$_GET["id"]]['title']; ?></li>
         </ol> 

         <h1><?php echo $images[$_GET["id"]]['title']; ?></h1>
         <div class="row">
		 <?php 
			//for ($i = 0; $i < count($images); $i++){				
				echo "<div class='col-md-8'>";
				echo 	"<img class = 'img-responsive' src='images/travel/medium/" . $images[$_GET["id"]]["path"] . "' alt='...'>";
				echo "</div>";
				echo "<div class='col-md-4'>";
				echo 	"<div class='panel panel-primary'>";
				echo 		"<div class='panel-body'>";
				echo 			"<p>By <a href='#'>" . $images[$_GET["id"]]["user"] . "</a></p>";
				echo    	"<p>Taken in <a href='#'>" . $images[$_GET["id"]]["country"] . "</a></p>";
				echo 		"<p>" . $images[$_GET["id"]]["description"]. "</p>";
				echo  		"</div>";
				echo 	"</div>";
				echo "</div>";
			//}
