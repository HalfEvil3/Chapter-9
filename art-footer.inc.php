      ...
      <div class="row">
         ...
         <div class="col-md-3">
			...
			for ($i = 0; $i < count($recentOrders); $i++){				
				...
				echo  	  	"<img class='media-object' src='images/art/tiny/" . $recentOrders[$i]["filename"] . "' alt='...'>";
				echo 	"</a>";
				echo 	"<div class='media-body'>";
				echo  		"<p class='media-heading similarTitle'><a href='#'> " . $recentOrders[$i]["title"] . "</a></p>";
				echo		"<em>" . $recentOrders[$i]["time"] . " minutes ago</em>";
				echo 	"</div>";
				echo "</div>";   				
			}
			?>
